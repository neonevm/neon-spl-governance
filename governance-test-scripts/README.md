...
spl-token -u http://localhost:8899 create-token --decimals 6 --fee-payer artifacts/payer.keypair --mint-authority artifacts/voter1.keypair governance-test-scripts/community_mint.keypair
```
