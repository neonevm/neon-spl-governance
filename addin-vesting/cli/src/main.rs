...
fn command_info(
    ...
    msg!("Vesting Owner: {:?}", &vesting_record.owner);
...
fn main() {
    let matches = App::new(crate_name!())
        ...
        .subcommand(SubCommand::with_name("deposit-with-realm").about("Create a new vesting contract for a Realm with an optional release schedule")        
            .arg(
                Arg::with_name("source_owner")
                    .long("source_owner")
                    .value_name("KEYPAIR")
        ...
        .subcommand(SubCommand::with_name("withdraw_with_realm").about("Unlock & Withdraw a vesting contract. This will only release \
        the schedules that have reached maturity.")
            .arg(
                Arg::with_name("payer")
                    .long("payer")
        ...
        .subcommand(SubCommand::with_name("change-owner-with-realm").about("Change the owner of a vesting contract for a Realm")
            .arg(
                Arg::with_name("payer")
                    .long("payer")
                    .value_name("KEYPAIR")
        ...
        .subcommand(SubCommand::with_name("set-vote-percentage-with-realm").about("Set vote percentage of a vesting contract for a Realm")
            .arg(
                Arg::with_name("payer")
                    .long("payer")
                    .value_name("KEYPAIR")
            ...
            .arg(
                Arg::with_name("vesting_aithority")
                    .long("vesting_aithority")
                    .value_name("KEYPAIR")
                    .required(true)
                    .validator(is_keypair)
                    .takes_value(true)
    ...
    let _ = match matches.subcommand() {
        ...
        ("deposit-with-realm", Some(arg_matches)) => {
            let source_keypair = keypair_of(arg_matches, "source_owner").unwrap();
            let source_token_pubkey = pubkey_of(arg_matches, "source_token_address");
            let vesting_owner_pubkey = pubkey_of(arg_matches, "vesting_owner").unwrap();
        ...
        ("withdraw-with-realm", Some(arg_matches)) => {
        ...
        ("change-owner-with-realm", Some(arg_matches)) => {
        ...
        ("set-vote-percentage-with-realm", Some(arg_matches)) => {
