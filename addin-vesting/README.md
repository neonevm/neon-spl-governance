This code based on token-vesting program from git@github.com:Bonfida/token-vesting.git
(commit: 1d1b3ef4747481251fcb213683a5c650a337de6f). The original content of the README.txt
file is shown below.
